...
class ForestGAN_ConvLSTM_basic_fg(BaseModel):
    def __init__(self, opt):
        
        super(ForestGAN_ConvLSTM_basic_fg, self).__init__(opt)
        self._name = 'forestgan_convlstm_basic_fg'
        self._opt = opt
        self._T = opt.T
        self._extra_ch_Gf = 2
        self._extra_ch_Gb = 0
    ...
    def _create_generator_f(self):
        return NetworksFactory.get_by_name('generator_wasserstein_gan_f_convlstm_mask_from_fg', c_dim=self._extra_ch_Gf, T=self._opt.T)
