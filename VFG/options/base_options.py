...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--T',                type=int,   default=48,                                     help='temporal horizon')
        ...
        self._parser.add_argument('--load_epoch',       type=int,   default=2200,                                 help='which epoch to load? set to -1 to use latest cached model')
        ...
        self._parser.add_argument('--num_patches',      type=int,   default = 8, help='number of patches/image to be compared')
