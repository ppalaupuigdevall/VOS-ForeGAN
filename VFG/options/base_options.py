...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--T',                type=int,   default=6,                                      help='temporal horizon')
        ...
        self._parser.add_argument('--name',             type=str,   default='experiment_9',                         help='name of the experiment. It decides where to store samples and models')
