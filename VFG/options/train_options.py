...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--nepochs_no_decay', type=int, default=7000, help='# of epochs at starting learning rate')
        ...
        self._parser.add_argument('--lambda_rec', type=float, default=0.00001, help='lambda reconstruction loss')
