...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # Lambdas for losses
        self._parser.add_argument('--lambda_Df_prob_fg',    type=float, default=0.1, help='lambda for real/fake discriminator loss')
        self._parser.add_argument('--lambda_Gf_prob_fg',    type=float, default=1, help='lambda for real/fake discriminator loss')
        self._parser.add_argument('--lambda_Df_prob_mask',  type=float, default=0.1, help='lambda for real/fake discriminator loss')
        ...
        self._parser.add_argument('--lambda_Df_gp',         type=float, default=0.1, help='lambda gradient penalty loss')
