...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--lambda_Gf_prob_fg', type=float, default=10, help='lambda for real/fake discriminator loss')
        self._parser.add_argument('--lambda_Df_prob_mask', type=float, default=10, help='lambda for real/fake discriminator loss')
        self._parser.add_argument('--lambda_Gf_prob_mask', type=float, default=10, help='lambda for real/fake discriminator loss')
        ...
        self._parser.add_argument('--lambda_rec', type=float, default=0.0001, help='lambda reconstruction loss')
