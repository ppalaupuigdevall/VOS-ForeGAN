...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--nepochs_no_decay', type=int, default=25000, help='# of epochs at starting learning rate')
        ...
        self._parser.add_argument('--lambda_Df_prob_mask',  type=float, default=5, help='lambda for real/fake discriminator loss')
