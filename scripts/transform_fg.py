...
tensor_mask = norma(to_tensor(transform_img(resize_img(masked_img,(224,416)))))
# tensor_mask = tensor_mask + (1-tensor_mask)*-1

mask_back = cv2.cvtColor(tensor2im(tensor_mask),cv2.COLOR_RGB2BGR)
cv2.imwrite('./fg_ori.png', masked_img)
cv2.imwrite('./transformed_fg.png', mask_back)